...
export function AppShell({ children }: { children: ReactNode }) {
  ...
  // Con el menú móvil abierto, bloquea el scroll de la página
  useEffect(() => {
        ...
        {menuOpen && (
          <>
            <button
              ...
              className="fixed inset-0 top-[57px] z-30 bg-black/30 backdrop-blur-[2px]"
            />
            <div className="fixed inset-x-0 top-[57px] z-40 max-h-[calc(100dvh-57px)] overflow-y-auto border-b border-line bg-surface p-4 shadow-card">
              {navList}
