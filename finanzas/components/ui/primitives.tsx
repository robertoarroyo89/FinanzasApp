...
const inputBase =
  "block w-full min-w-0 appearance-none rounded-xl border border-line bg-surface px-3.5 py-2.5 text-sm text-ink placeholder:text-muted/70 focus:border-primary";
